...
export const RECENTLY_FUNDED: RecentlyFunded[] = [
  ...
  },
  {
    ...
    amount: "$110M",
    date: "2026-03-12",
    tagline: "AI agent startup expanding the same Series B from $275M to $385M total at a $1.6B valuation — roughly 20 employees generating $200M+ ARR. Founded by ex-Baidu exec Eric Jing, former CEO of Baidu's Xiaodu. Flagship product: Genspark Super Agent, an agentic AI browser assistant.",
    color: "#7c3aed",
  ...
  },
  {
    ...
    amount: "$500M",
    date: "2026-03-11",
    tagline: "Full-stack industrial AI robotics — foundation models, purpose-built robots, and deployment infrastructure for dexterous manufacturing tasks. Co-led by Accel and a16z.",
    color: "#7c3aed",
