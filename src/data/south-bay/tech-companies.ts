...
export const SCC_SPOTLIGHT: SccTechSpotlight[] = [
  ...
  },
  {
    ...
    category: "chip",
    stage: "public",
    tagline: "Semiconductors and enterprise software (VMware), headquartered in Palo Alto.",
    color: "#CC0000",
  ...
  },
  {
    ...
    category: "eda",
    stage: "public",
    tagline: "Electronic design automation software used to develop advanced semiconductors.",
    color: "#00A896",
  ...
  },
  {
    ...
    category: "medtech",
    stage: "public",
    tagline: "da Vinci robotic surgery systems from a pioneer in robot-assisted surgery.",
    color: "#00A3E0",
  ...
  },
  {
    ...
    category: "chip",
    stage: "public",
    tagline: "Wafer-scale AI processors built on a single chip roughly the size of a dinner plate. Went public on the Nasdaq (CBRS) May 14, 2026, raising about $5.5B and surging roughly 68% on debut.",
    color: "#FF4D00",
  ...
  },
  {
    ...
    category: "hardware",
    stage: "public",
    tagline: "Flash storage company making consumer SSDs, memory cards, and enterprise NAND solutions. Spun off from Western Digital in February 2025 and trades independently as SNDK; founded in 1988 and headquartered in Milpitas.",
    color: "#E31937",
  ...
  },
  {
    ...
    category: "security",
    stage: "growth",
    tagline: "Enterprise cybersecurity platform (XDR) formed in 2022 from the merger of McAfee Enterprise and FireEye. Protects governments and large enterprises from advanced persistent threats.",
    color: "#C41E3A",
  ...
  },
  {
    ...
    category: "hardware",
    stage: "public",
    tagline: "EV charging hardware, software, and network services from a company headquartered in Campbell, with stations across the South Bay.",
    color: "#0C4B1E",
  ...
  },
  {
    ...
    category: "security",
    stage: "growth",
    tagline: "Email security and cloud backup protecting 200,000+ businesses from spam, ransomware, and data loss. Founded in 2003 by Dean Drako, Michael Perone, and Zach Levow; privately held after KKR bought it from Thoma Bravo in 2022.",
    color: "#E01E24",
  ...
  },
  {
    ...
    category: "hardware",
    stage: "public",
    tagline: "After spinning off SanDisk in February 2025, Western Digital focuses on hard drives and enterprise cloud storage for data centers. The company has operated in San Jose since 1970.",
    color: "#003DA5",
  ...
  },
  {
    ...
    category: "software",
    stage: "public",
    tagline: "Subscription streaming service headquartered in Los Gatos. Founded in 1997, Netflix helped make on-demand streaming mainstream. ~13,000 employees globally.",
    color: "#E50914",
