...
export const RECENTLY_FUNDED: RecentlyFunded[] = [
  ...
  },
  {
    ...
    amount: "$100M",
    date: "2026-06-11",
    tagline: "AI-agent startup whose Genspark Super Agent autonomously runs multi-step knowledge work — research, slide decks, documents, and web tasks. This Series B extension pushed total funding past $645M at a $2.6B valuation, with Sozo Ventures, UpHonest Capital, and Mirae Asset joining. Founded by ex-Baidu exec Eric Jing, former CEO of Baidu's Xiaodu.",
    color: "#7c3aed",
