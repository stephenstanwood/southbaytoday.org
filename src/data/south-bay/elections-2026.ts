...
export const RACES: Race[] = [
  ...
  },
  {
    id: "sj-council-d1",
    emoji: "🏙️",
    race: "San José Council — District 1",
    scope: "city",
    summary: "West San Jose / Cupertino border, parts of Willow Glen. Incumbent unopposed.",
    candidates: [
      { name: "Rosemary Kamei", party: "NP", note: "incumbent, first elected 2022", incumbent: true },
    ],
  ...
  },
  {
    id: "sj-council-d3",
    emoji: "🏙️",
    race: "San José Council — District 3",
    scope: "city",
    summary: "Downtown San José. Tordillos won 2025 special election to fill Omar Torres seat; now seeking first full term, unopposed.",
    candidates: [
      { name: "Anthony Tordillos", party: "NP", note: "incumbent; ex-YouTube engineer, former Planning Commission chair", incumbent: true },
    ],
    infoUrl: "https://www.sanjoseca.gov/your-government/appointees/city-clerk/elections/2026-elections-primary-and-runoff",
    unopposed: true,
  },
  {
    id: "sj-council-d5",
    emoji: "🏙️",
    race: "San José Council — District 5",
    scope: "city",
    summary: "East San José (Alum Rock, Mt. Pleasant). Four-way contest — top two advance to November if no candidate clears 50%.",
    candidates: [
      { name: "Peter Ortiz",     party: "NP", note: "incumbent, first elected 2022", incumbent: true },
      { name: "Nora Campos",     party: "NP", note: "former councilmember and state Assembly member" },
      { name: "Karen Martinez",  party: "NP", note: "local education leader" },
      { name: "Vy Dang",         party: "NP", note: "broadcast journalist" },
    ],
    infoUrl: "https://www.sanjoseca.gov/your-government/appointees/city-clerk/elections/2026-elections-primary-and-runoff",
  },
  {
    id: "sj-council-d7",
    emoji: "🏙️",
    race: "San José Council — District 7",
    scope: "city",
    summary: "South-central / Edenvale and parts of East Side. Three-way contest — top two advance to November if no majority.",
    candidates: [
      { name: "Bien Doan",         party: "NP", note: "incumbent, first elected 2022", incumbent: true },
      { name: "Van Le",            party: "NP", note: "East Side Union HSD trustee" },
      { name: "Hanh-Giao Nguyen",  party: "NP", note: "City Hall staffer" },
    ],
    infoUrl: "https://www.sanjoseca.gov/your-government/appointees/city-clerk/elections/2026-elections-primary-and-runoff",
  },
  {
    id: "sj-council-d9",
    emoji: "🏙️",
    race: "San José Council — District 9",
    scope: "city",
    summary: "Cambrian / Willow Glen / Almaden. Open seat — Vice Mayor Pam Foley termed out. Top two advance to November runoff.",
    candidates: [
      { name: "Scott Hughes",   party: "NP", note: "Foley's chief of staff" },
      { name: "Gordon Chester", party: "NP", note: "longtime city employee" },
      { name: "Genny Altwer",   party: "NP", note: "licensed marriage and family therapist" },
      { name: "Mike Hennessy",  party: "NP", note: "local entrepreneur" },
    ],
    infoUrl: "https://www.sanjoseca.gov/your-government/appointees/city-clerk/elections/2026-elections-primary-and-runoff",
  },
];
