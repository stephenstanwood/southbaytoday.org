...
async function main() {
  ...
  console.log(`events: ${data.todayEvents.length}, openings: ${data.recentlyOpened.length} opened / ${data.comingSoon.length} soon, history: ${data.todayHistory.length}, meetings: ${data.tonightMeetings.length}`);
